...
export const BentoGridItem = ({
  ...
  const rightLists = ["ReactJS", "Prisma", "ShadCN"];
  ...
  const handleCopy = () => {
    if (typeof window !== "undefined" && navigator.clipboard) {
      navigator.clipboard.writeText("pratyush.epi.spn117@gmail.com");
      setCopied(true);
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full relative`}>
        {img && (
          <img src={img} alt={img} className={cn(imgClassName, "object-cover object-center w-full h-full")} />
        )}
        {spareImg && (
          <img src={spareImg} alt={spareImg} className="absolute right-0 -bottom-5 w-full opacity-80" />
        )}
        ...
        <div className={cn(
          ...
          {/* Email Copy Button with Animation */}
          {id === 6 && isClient && (
